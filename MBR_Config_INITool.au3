...
Global $tbSettings = 0, $tbDebug = 0, $tbDeleteFiles = 0, $tbOther = 0, $tbAndroid = 0, $tbNoyify = 0
Global $cmbKeySettings = 0, $cmbKeyDebug = 0, $cmbKeyDeleteFiles = 0, $cmbKeyOther = 0, $cmbKeyAndroid = 0, $cmbKeyNotify = 0
Global $txtValueSettings = 0, $txtValueDebug = 0, $txtValueDeleteFiles = 0, $txtValueOther = 0, $txtAndroid = 0, $txtNotify = 0
Global $g_aBtnReloadSettings = 0, $g_aBtnReloadDebug = 0, $g_aBtnReloadDeleteFiles = 0, $g_aBtnReloadOther = 0, $g_aBtnReloadAndroid = 0, $g_aBtnReloadNotify = 0
Global $lblValueSettings = 0, $lblValueDebug = 0, $lblValueDeleteFiles = 0, $lblValueOther = 0, $lblValueAndroid = 0, $lblValueNotify = 0
Global $lblValuetSettings = 0, $lblValuetDebug = 0, $lblValuetDeleteFiles = 0, $lblValuetOther = 0, $lblValuetAndroid = 0, $lblValuetNotify = 0
Global $g_lblHelp[6]
...
Global $g_aTitles = ["General", "Debug", "DeleteFiles", "Other", "Android", "Notify"]
Global $g_aTabs = [$tbSettings, $tbDebug, $tbDeleteFiles, $tbOther, $tbAndroid, $tbNoyify]
Global $g_aCmbKey = [$cmbKeySettings, $cmbKeyDebug, $cmbKeyDeleteFiles, $cmbKeyOther, $cmbKeyAndroid, $cmbKeyNotify]
Global $g_aTxtValue = [$txtValueSettings, $txtValueDebug, $txtValueDeleteFiles, $txtValueOther, $txtAndroid, $txtNotify]
Global $g_aBtnReload = [$g_aBtnReloadSettings, $g_aBtnReloadDebug, $g_aBtnReloadDeleteFiles, $g_aBtnReloadOther, $g_aBtnReloadAndroid, $g_aBtnReloadNotify]
Global $g_alblValue = [$lblValueSettings, $lblValueDebug, $lblValueDeleteFiles, $lblValueOther, $lblValueAndroid, $lblValueNotify]
Global $g_alblVar = [$lblValuetSettings, $lblValuetDebug, $lblValuetDeleteFiles, $lblValuetOther, $lblValuetAndroid, $lblValuetNotify]
Global $g_lblHelpInfo = [$lblHelpGeneral, $lblHelpDebug, $lblHelpDeleteFiles, $lblHelpOther, $lblHelpAndroid, $lblHelpNotify]
...
While 1
	...
	Switch $nMsg
		...
		Case $g_aBtnReload[0], $g_aBtnReload[1], $g_aBtnReload[2], $g_aBtnReload[3], $g_aBtnReload[4], $g_aBtnReload[5]
			LoadKeys()
		Case $g_aCmbKey[0], $g_aCmbKey[1], $g_aCmbKey[2], $g_aCmbKey[3], $g_aCmbKey[4], $g_aCmbKey[5]
			LoadValues()
	EndSwitch
WEnd
